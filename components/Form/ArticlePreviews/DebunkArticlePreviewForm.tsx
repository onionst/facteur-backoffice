          ...
          {form.claimReviews.map((claimReview: any, key: number) => {
            return (
              <div key={key}>
                ...
                <TextArea label="Claim" value={claimReview.claimReviewedNative} type="text" minLength={10} disabled />
                <Row align="SPACE">
                  <Select
                    label="Rating"
                    disabled
                ...
                {props.type === ArticleType.Factcheck && (
                  <Row align="SPACE">
                    <Input value={claimReview.itemReviewed.author} label="Person" disabled />
                    <Input value={claimReview.itemReviewed.politicalParty} disabled label="EU party related to the claim" />
                  </Row>
                )}
